 ...
 * @author dustinmiller
 */
class ServU_Customer_Model_Convert_Adapter_Customer 
    ...
    public function saveRow($importData)
    {
        ...
        $customer->setPassword($customer->generatePassword(8)); // Added by DEM
        $customer->save();
        //$customer->sendNewAccountEmail('import');  // Added by DEM 
        $saveCustomer = false;
