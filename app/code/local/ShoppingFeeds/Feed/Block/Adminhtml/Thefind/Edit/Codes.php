 ...
 */
class ShoppingFeeds_Feed_Block_Adminhtml_Thefind_Edit_Codes extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_thefind_edit_codes';

        parent::__construct();

        $this->_removeButton('back');
        $url = $this->getUrl('*/thefind_codes_grid/saveForm');
    ...
    {
        return Mage::helper('shoppingfeeds_feed')->__('TheFind Import Attribute Map');
    }
}
