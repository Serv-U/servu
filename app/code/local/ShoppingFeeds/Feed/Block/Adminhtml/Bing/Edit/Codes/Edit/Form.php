 ...
 */
class ShoppingFeeds_Feed_Block_Adminhtml_Bing_Edit_Codes_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Import codes list
     *
    ...
    {
        $attributes = Mage::getConfig()->getNode(ShoppingFeeds_Feed_Model_Bingimport::XML_NODE_BING_FEED_ATTRIBUTES)->children();
        $result     = array();
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('import_code', 'select', array(
            'label'     => Mage::helper('shoppingfeeds_feed')->__('Bing\'s Import code'),
            'name'      => 'import_code',
            'required'  => true,
        ...
        $fieldset->addField('enabled', 'select', array(
            'label'     => Mage::helper('shoppingfeeds_feed')->__('Is imported'),
            'name'      => 'enabled',
            'value'     => 1,
