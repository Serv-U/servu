 ...
 */
class ShoppingFeeds_Feed_Block_Adminhtml_Bing_List_Codes extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->_controller      = 'adminhtml_bing_list_codes';
        $this->_headerText      = Mage::helper('shoppingfeeds_feed')->__('Manage Attributes for Bing\'s Feed');
        $this->_addButtonLabel  = Mage::helper('shoppingfeeds_feed')->__('Add new');

        parent::__construct();

        $url = $this->getUrl('*/bing_codes_grid/editForm');
