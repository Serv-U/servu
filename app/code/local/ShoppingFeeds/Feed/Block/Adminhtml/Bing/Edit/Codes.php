 ...
 */
class ShoppingFeeds_Feed_Block_Adminhtml_Bing_Edit_Codes extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->_controller = 'adminhtml_bing_edit_codes';

        parent::__construct();

        $this->_removeButton('back');
        $url = $this->getUrl('*/bing_codes_grid/saveForm');
    ...
    {
        return Mage::helper('shoppingfeeds_feed')->__('Bing\'s Import Attribute Map');
    }
}
