 ...
 */
class ShoppingFeeds_Feed_Helper_Thefind extends ShoppingFeeds_Feed_Helper_Data
{
    /**
    ...
    {
        $attributeConfig = Mage::getConfig()->getNode(ShoppingFeeds_Feed_Model_Thefindimport::XML_NODE_FIND_FEED_ATTRIBUTES);
