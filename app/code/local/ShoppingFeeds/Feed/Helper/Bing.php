 ...
 */
class ShoppingFeeds_Feed_Helper_Bing extends ShoppingFeeds_Feed_Helper_Data
{
    /**
    ...
    {
        $attributeConfig = Mage::getConfig()->getNode(ShoppingFeeds_Feed_Model_Bingimport::XML_NODE_BING_FEED_ATTRIBUTES);
