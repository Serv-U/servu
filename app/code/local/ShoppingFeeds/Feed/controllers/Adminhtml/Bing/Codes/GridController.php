 ...
 */
class ShoppingFeeds_Feed_Adminhtml_Bing_Codes_GridController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Main index action
     *
    ...
    {
        $this->loadLayout();
        $this->getResponse()->setBody($this->getLayout()->createBlock('shoppingfeeds_feed/adminhtml_bing_list_codes_grid')->toHtml());
    }
    ...
    {
        $this->loadLayout();
        $this->getResponse()->setBody($this->getLayout()->createBlock('shoppingfeeds_feed/adminhtml_bing_edit_codes')->toHtml());
    }
    ...
    public function saveFormAction()
    {
        ...
        try {
            $model  = Mage::getModel('shoppingfeeds_feed/bingcodes');
            if ($codeId) {
                $model->load($codeId);
            }
