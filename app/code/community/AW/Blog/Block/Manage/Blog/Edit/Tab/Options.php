...
class AW_Blog_Block_Manage_Blog_Edit_Tab_Options extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('googleplus', 'text', array(
            'label' => Mage::helper('blog')->__('Google Plus URL'),
            'name' => 'googleplus',
            'style' => 'width: 520px;',
            'after_element_html' => '<span class="hint">('.Mage::helper('blog')->__('Leave blank to use default GooglePlus URL specified under Blog Settings.').')</span>',
        ));
