...
Checkout.prototype = {
    initialize: function(accordion, urls){
        ...
        this.steps = ['login', 'billing', 'shipping', 'shipping_method', 'payment', 'review', 'shipping-update'];
...
// shipping method
var UpdateShippingMethod = Class.create();
UpdateShippingMethod.prototype = {
    ...
    save: function(){
        if (checkout.loadWaiting!=false) return;
            checkout.setLoadWaiting('shipping-update');
            var request = new Ajax.Request(
                this.saveUrl,
                {
                    method:'post',
